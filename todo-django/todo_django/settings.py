...
SECRET_KEY = '6dv@syo$j6!v#acp!*!))d!vsqy@s-scxgn4#egvxq%98*@-_o'
...
MIDDLEWARE = [
    ...
    'corsheaders.middleware.CorsMiddleware', # CommonMiddleware 반드시 바로 위에 추가 해줄 것!
